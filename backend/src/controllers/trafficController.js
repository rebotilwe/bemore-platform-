...
export async function trafficOverview(req, res) {
  try {
    ...
    res.status(500).json({ success: false, error: 'Failed to load traffic overview' });
  }
}
...
export async function trafficTrends(req, res) {
  try {
    ...
    res.status(500).json({ success: false, error: 'Failed to load traffic trends' });
  }
}
...
export async function trafficReferrers(req, res) {
  try {
    ...
    res.status(500).json({ success: false, error: 'Failed to load referrer data' });
  }
}
...
export async function trafficDevices(req, res) {
  try {
    ...
    res.status(500).json({ success: false, error: 'Failed to load device data' });
  }
}
...
export async function trafficHours(req, res) {
  try {
    ...
    res.status(500).json({ success: false, error: 'Failed to load hourly data' });
  }
}
...
export async function trafficFormFunnel(req, res) {
  try {
    ...
    res.status(500).json({ success: false, error: 'Failed to load form funnel' });
  }
}
