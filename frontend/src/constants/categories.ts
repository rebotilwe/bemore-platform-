...
export const CATEGORIES: CategoryMeta[] = [
  ...
  { slug: 'student',      icon: '🎓', title: 'Student Accommodation Operator',    description: 'Scale your portfolio with institutional backing from DBSA and NHFC. High-occupancy operators get priority access.' },
